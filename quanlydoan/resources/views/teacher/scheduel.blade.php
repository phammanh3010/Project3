                                    ...
                                    <div class="row">
                                        <table class="table" id="result">
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><a href="{{url()->current()}}/update/{{$scheduel_content->id_content}}" class="delete btn btn-default">Sửa</a></td>
                                                <td class="text-center"><button type="button" id="{{$scheduel_content->id_content}}" class="delete btn btn-default">Xóa</button></td>
                                            </tr>
                                            @endforeach
                                        </table>
                                    </div>
                                        ...
                                        <div class="form">
                                            <form class="form-validate form-horizontal" id="feedback_form" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-1">
                                                        <input class="form-control" id="penalty" value="0" type="number" step="0.25" min="0" max="10"/>
                                                    </div>
                                                </div>
